...
<?php
    ...
    if(!isset($_POST['ort']) or empty($_POST['ort']) or is_null($_POST['ort']) or trim($_POST['ort'])=="")
        {
    ...
    update_option( 'weatherwoeid' , $woeid, false );
    update_option( 'weathername' , $locationname, false );
